...
<<<<<<< HEAD
        ...
        <form class="form-login" action="{{ url('product/store') }}" method="POST" enctype="multipart/form-data">
=======
...
<<<<<<< HEAD
                    ...
                    <div class="col-md-9">
                        <div class="form-group form-group-md mb-3">
                            <input class="form-control form-control-sm" id="harga" type="number" name="harga" required> 
=======
