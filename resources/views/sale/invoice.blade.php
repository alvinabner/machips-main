...
<<<<<<< HEAD
                            <h2>28 2123 1414</h2> <span class="pull-right">Expiry date: {{ now()->subDays(3)->format('d/m/y') }}</span> <span class="font-500">Alvin Abner</span>
=======
...
<<<<<<< HEAD
                            <h2>28 2123 1414</h2> <span class="pull-right">Expiry date: {{ now()->subDays(3)->format('d/m/y') }}</span> <span class="font-500">Dinda Sherly</span>
=======
                            <h2>322 0539 791</h2> <span class="pull-right">Expiry date: {{ now()->subDays(3)->format('d/m/y') }}</span> <span class="font-500">Deviska Adi Nugroho</span>
>>>>>>> e64af6b (First Commit)
                        </div>
