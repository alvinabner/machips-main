...
<<<<<<< HEAD
    public function job_success(Request $request, sale $sale, $id)
    {
        try {
    ...
    public function job_failed(Request $request, sale $sale, $id)
    {
        try {
...
<<<<<<< HEAD
    ...
    {
        // $products = Auth::guard('user')->user()->product()->get();
